            ...
            <section
                ...
                <div
                    ...
                    <div>
                        ...
                        @if (old('status', $buyer->status) === 'active')
                            <p
                                class="mt-2
                                       flex
                                       items-center
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input :type="showConfirmation ? 'text' : 'password'" name="password_confirmation"
                                id="password_confirmation" autocomplete="new-password" placeholder="Ulangi password baru"
                                class="h-11
                                       w-full
                                       rounded-xl
                                       border
