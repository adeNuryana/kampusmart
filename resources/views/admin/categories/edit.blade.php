                ...
                <div class="space-y-5 p-5 sm:p-6">
                    ...
                    <div>
                        ...
                        <select id="icon" name="icon"
                            ...
                            <option value="food" @selected(old('icon', $category->icon) === 'food')>
                                🍴 Makanan
                            </option>

                            <option value="drink" @selected(old('icon', $category->icon) === 'drink')>
                                ☕ Minuman
                            </option>

                            <option value="book" @selected(old('icon', $category->icon) === 'book')>
                                📚 Buku
                            </option>

                            <option value="electronic" @selected(old('icon', $category->icon) === 'electronic')>
                                💻 Elektronik
                            </option>

                            <option value="fashion" @selected(old('icon', $category->icon) === 'fashion')>
                                👕 Fashion
                            </option>

                            <option value="service" @selected(old('icon', $category->icon) === 'service')>
                                🛠 Jasa
                            </option>
